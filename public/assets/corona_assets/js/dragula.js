  ...
  dragula([document.getElementById("dragula-event-left"), document.getElementById("dragula-event-right")])
    .on('drop', function(el) {
      ...
      if (iconTochange.hasClass('mdi-check')) {
        iconTochange.removeClass('mdi-check text-primary').addClass('mdi-check-all text-orange');
      } else if (iconTochange.hasClass('mdi-check-all')) {
        iconTochange.removeClass('mdi-check-all text-orange').addClass('mdi-check text-primary');
      }
    })
})(jQuery);